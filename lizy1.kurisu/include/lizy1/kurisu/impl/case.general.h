...
protected:
    ...
    using eB  = _C<bC::value, eB0, int>;                                                 // B: T if T is complete else int
    using eD0 = _mf;                                                                     // D: case
    using eD1 = _C<Case_Integral<eB>::is_matched, Case_Integral<eB>, eD0>;
    using eD2 = _C<Case_Floating<eB>::is_matched, Case_Floating<eB>, eD1>;
    using eD3 = _C<Case_Enum<eB>::is_matched, Case_Enum<eB>, eD2>;
    using eD4 = _C<Case_Array<eB>::is_matched, Case_Array<eB>, eD3>;
    using eD  = _C<Case_Struct<eB>::is_matched, Case_Struct<eB>, eD4>;
